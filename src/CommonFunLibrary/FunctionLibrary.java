...
public class FunctionLibrary {
	...
	public static WebDriver startBrowser() throws Throwable {
		...
		if (PropertyFileUtil.getValueForKey("Browser").equalsIgnoreCase("chrome")) {
			System.setProperty("webdriver.chrome.driver",
					"D:\\Selenium_Evening\\ERP_Stock\\CommonDriver\\chromedriver.exe");
	...
	public static void tableValidation(WebDriver driver, String testdata) throws Throwable {
		...
		// column columndata into integer
		...
		for (int i = 1; i < rows.size(); i++) {
			String act_data = driver
					.findElement(By.xpath(
							"//table[@id='tbl_a_supplierslist']/tbody/tr[" + i + "]/td[" + column + "]/div/span/span"))
					.getText();
			Thread.sleep(5000);
